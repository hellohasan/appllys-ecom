                            ...
                            <div class="product-gallery product-gallery-vertical">
                                <div class="row">
                                    ...
                                    <figure class="product-main-image">
                                        <img id="product-zoom" src="{{ asset("storage/products/{$img->name}_458X458.webp") }}" data-zoom-image="{{ asset("storage/products/{$img->name}_458X458.webp") }}" alt="product image">
                                    ...
                                    <div id="product-zoom-gallery" class="product-image-gallery">
                                        @foreach ($product->images as $image)
                                            <a class="product-gallery-item active" href="#" data-image="{{ asset("storage/products/{$image->name}_458X458.webp") }}" data-zoom-image="{{ asset("storage/products/{$image->name}_458X458.webp") }}">
                                                <img src="{{ asset("storage/products/{$image->name}_107X107.webp") }}" alt="product side">
                                            </a>
                                        @endforeach
                                    </div>
                                </div>
