                    ...
                    <div class="header-right">
                        <ul class="top-menu">
                            <li>
                                <a href="#">Links</a>
                                <ul>
                                    <li><a href="tel:{{ $basic->phone }}"><i class="icon-phone"></i>Call: {{ $basic->phone }}</a></li>
                ...
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="{{ route('home') }}" class="logo">
                            <img src="{{ asset('img/logo.png') }}" alt="Molla Logo" width="105" height="25">
                        </a>
                    </div><!-- End .header-left -->
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="widget widget-about">
                                <img src="{{ asset('img/logo.png') }}" class="footer-logo" alt="Footer Logo" width="105" height="25">
