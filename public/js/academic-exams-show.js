"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["academic-exams-show"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    loadAcademicExamDetails: function loadAcademicExamDetails() {
      ...
      axios.get("/api/academic-exams/".concat(this.$route.params.custom)).then(function (res) {
        _this.exam = res.data;
      });
    }
  },
                ...
                _c(
                  ...
                  [
                    ...
                    _c("tr", [
                      ...
                      _c("td", [
                        _vm._v(
                          _vm._s(_vm.exam.session.title) +
                            " - (" +
                            _vm._s(_vm.exam.session.duration) +
                            ")"
                        ),
                      ]),
                    ]),
            ...
            _c("table", { staticClass: "table table-bordered table-striped" }, [
              _c("thead", [
                _c("tr", [
                  ...
                  _vm._v(" "),
                  _c("th", [_vm._v(_vm._s(_vm.$t("Result")))]),
                  _vm._v(" "),
                ...
                _vm._l(_vm.exam.classes, function (list, i) {
                  return _c("tr", { key: i }, [
                    ...
                    _c("td", [
                      _vm._v(
                        "\n\t\t\t\t\t\t\t\t" +
                          _vm._s(list.academic_class.name) +
                          "\n\t\t\t\t\t\t\t"
                      ),
                    ]),
                    _vm._v(" "),
                            ...
                            directives: [
                              {
                                name: "permission",
                                rawName: "v-permission",
                                value: ["academic-exams-result"],
                                expression: "['academic-exams-result']",
                              },
                            ],
                            ...
                            directives: [
                              {
                                name: "permission",
                                rawName: "v-permission",
                                value: ["academic-exams-routine-print"],
                                expression: "['academic-exams-routine-print']",
                              },
                            ],
                            staticClass: "btn btn-sm btn-success",
                            attrs: {
