"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["academic-exams-create"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    submitExam: function submitExam() {
      ...
      this.form.post('/api/academic-exams').then(function (res) {
        _this2.successCreateMessage();

        _this2.$router.push("/academic-exams/".concat(res.data.custom, "/show"));
    ...
    loadAcademicClass: function loadAcademicClass() {
      ...
      axios.get("/api/load-classes-sections-groups-departments-years").then(function (res) {
        ...
        _this3.departments = res.data.departments;
        _this3.groups = res.data.groups;
        _this3.sections = res.data.sections;
        _this3.years = res.data.years;
      });
    },
    loadAcademicSessions: function loadAcademicSessions() {
      var _this4 = this;

      axios.get('/api/load-academic-session-list').then(function (res) {
